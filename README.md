...
Welcome to my problem-solving repository! Here, I track my progress from Python fundamentals to LeetCode Data Structures and Algorithms (DSA) problems.

---

## 📚 Repository Structure

- `practice/` : Fundamental Python concepts (Variables, Loops, Conditions, Lists, etc.)
- `leetcode/` : LeetCode DSA problem solutions categorized by difficulty.
...
| 0135 | [Candy](https://leetcode.com/problems/candy/?envType=study-plan-v2&envId=top-interview-150) | [Python](./leetcode/hard/candy.py) | 🟢Hard | Arrays / Greedy |
